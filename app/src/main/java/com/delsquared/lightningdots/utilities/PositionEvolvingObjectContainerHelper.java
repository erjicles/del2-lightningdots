...
public class PositionEvolvingObjectContainerHelper<T extends IPositionEvolvingObject> {
    ...
    public PositionEvolvingObjectContainerHelper() {
    }
    ...
    public void evolveTime(double dt, PositionEvolvingObjectContainer<T> positionEvolvingObjectContainer) {
        ...
        for (SyncVariableTrigger syncVariableTrigger : listGeneratedSyncVariableTriggers) {
            ...
            if (syncVariableTrigger.mode == SyncVariableTrigger.MODE.SNAP_TO_TARGET) {
                ...
                T sourceObject = positionEvolvingObjectContainer
                        .getCollectionObjects()
                        .getObject(syncVariableTrigger.sourceObjectName);
                T targetObject = positionEvolvingObjectContainer
                        .getCollectionObjects()
                        .getObject(syncVariableTrigger.targetObjectName);
